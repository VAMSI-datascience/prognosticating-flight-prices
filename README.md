...
![heroku](https://user-images.githubusercontent.com/51853466/87663549-9d2e7e80-c781-11ea-8407-934f11dd5e19.PNG)
...
## Deploy in your local system
+ Install all the libraries mentioned in the [requirements.txt]
+ Clone this repository in your local system.
+ Open the command prompt from your project directory and run the command app.py.
